...
//   return (
//     <nav className="sticky top-0 w-full z-50  bg-[linear-gradient(to_right,#121212_0%,#141518_10%,#1C263B_50%,#141518_90%,#121212_100%)] backdrop-blur-md shadow-none">
...
export default function Navbar() {
  ...
  return (
    // Navbar এর নিচের বর্ডার বা শ্যাডো রাখা যাবে না যাতে ব্যানারের সাথে মিশে যায়
